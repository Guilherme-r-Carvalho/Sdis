...
class AddressBookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.listAll = channel.unary_unary(
                ...
                request_serializer=AddressBook__pb2.ListAllRequest.SerializeToString,
                response_deserializer=AddressBook__pb2.ListAllResponse.FromString,
                )
...
def add_AddressBookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'listAll': grpc.unary_unary_rpc_method_handler(
                    servicer.listAll,
                    request_deserializer=AddressBook__pb2.ListAllRequest.FromString,
                    response_serializer=AddressBook__pb2.ListAllResponse.SerializeToString,
            ),
    }
...
class AddressBookService(object):
    ...
    def listAll(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/pt.tecnico.addressbook.grpc.AddressBookService/listAll',
            AddressBook__pb2.ListAllRequest.SerializeToString,
            AddressBook__pb2.ListAllResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
